...
def sample_market_analysis():
    return {
        ...
        "keywords": [
            {"keyword": "电子血压计", "search_volume": 5200, "heat_score": 85, "trend": "rising",
             "click_rate": 0.12, "conversion_rate": 0.08, "growth_rate": 0.15},
            {"keyword": "血糖试纸", "search_volume": 3800, "heat_score": 72, "trend": "stable",
             "click_rate": 0.1, "conversion_rate": 0.06, "growth_rate": 0.05},
        ],
        "products": [
            {"name": "鱼跃电子血压计", "monthly_sales": 320, "avg_price": 189, "category": "血压计", "rank": 1},
            {"name": "欧姆龙血压计", "monthly_sales": 280, "avg_price": 259, "category": "血压计", "rank": 2},
        ],
...
def sample_competitor_analysis():
    return {
        ...
        "gap_products": [
            {"product_name": "制氧机", "competitor_count": 3, "avg_price": 2500,
             "estimated_monthly_sales": 15, "priority": "high"},
        ],
...
def sample_inventory_analysis():
    return {
        "inventory_summary": {
            "total_sku": 120, "total_stock_value": 85000, "health_score": 72,
            "fast_moving_percent": 35, "dead_stock_percent": 8,
        },
        "covered_keywords": ["血压计", "体温计", "创可贴"],
        "problem_products": [
            {"product_id": "P001", "name": "某品牌雾化器", "status": "slow_moving",
             "days_since_last_sale": 45, "action": "促销清仓"},
        ],
    }
...
def sample_seasonal_factors():
    return {
        ...
        "factors": [
            {"event_name": "冬季流感", "event_type": "season", "impact_level": "high",
             "days_away": 0, "urgency": "urgent", "affected_products": ["口罩", "体温计"],
             "expected_demand_change": 0.3},
        ],
        "weather_impact": {
            "summary": "寒潮来袭", "impact_level": "medium",
...
def sample_gap_opportunities():
    return {
        ...
        "opportunities": [
            {"rank": 1, "keyword": "制氧机", "priority": "high", "market_heat_score": 78,
             "competitor_coverage": 3, "stockout_opportunity": False,
             "reason": "市场需求大，竞品覆盖少"},
            {"rank": 2, "keyword": "雾化器", "priority": "medium", "market_heat_score": 55,
             "competitor_coverage": 1, "stockout_opportunity": True,
             "reason": "竞品缺货"},
        ],
    }
...
def sample_supplier_evaluation():
    return {
        "keyword": "制氧机",
        "recommendation": {"best_channel": "alibaba", "reason": "资质齐全，价格优势", "confidence": 0.85},
        "alibaba_evaluation": {
            "supplier_name": "鱼跃旗舰店", "qualification_score": 92,
            "unit_cost": 1200, "moq": 5, "delivery_days": 3,
            "risk_level": "low", "pros": ["品牌正品"], "cons": ["MOQ较高"],
            "url": "https://detail.1688.com/xxx",
        },
        "pdd_evaluation": {
            "shop_name": "医疗器械直营", "shop_score": 4.6,
            "unit_cost": 1350, "sales_count": 500, "delivery_days": 2,
            "pros": ["发货快"], "cons": ["价格略高"],
            "url": "https://mobile.yangkeduo.com/xxx",
        },
        "cost_comparison": {
            "alibaba_unit_cost": 1200, "pdd_unit_cost": 1350,
            "price_difference_percent": 12.5, "cheaper_channel": "alibaba",
        },
        "margin_analysis": {
            "market_price": 2500, "suggested_price": 2299,
            "gross_margin_percent": 47.8, "margin_grade": "excellent",
        },
        "final_suggestion": {
            "should_purchase": True, "channel": "alibaba",
            "suggested_quantity": 10, "estimated_investment": 12000,
            "url": "https://detail.1688.com/xxx",
        },
    }
...
def sample_recommendations():
    return {
        "scoring_summary": {"total_evaluated": 3, "recommended_count": 2, "top_score": 87.5, "avg_score": 72.3},
        "recommendations": [
            {
                "rank": 1, "keyword": "制氧机", "final_score": 87.5,
                "score_breakdown": {
                    "market_heat": 85, "competition_gap": 90, "supply_chain": 88,
                    "profit_margin": 92, "category_synergy": 80, "seasonal_fit": 75,
                },
                ...
                "suggested_quantity": 10, "suggested_price": 2299, "expected_margin": 47.8,
            },
        ],
...
def sample_anomalies_found():
    return {
        "detection_summary": {
            "total_products_checked": 50, "anomalies_found": 2,
            "critical_count": 1, "warning_count": 1,
        },
        "anomalies": [
            {
                "anomaly_id": "A001", "product_id": "P100", "product_name": "鱼跃血压计",
                "anomaly_type": "sales_drop_prophet", "severity": "critical",
                "detection_method": "prophet",
                "metrics": {"expected_value": 10, "actual_value": 3, "deviation_percent": -70, "threshold": -30},
                "description": "销量偏离预测值70%", "detected_at": "2026-02-11T10:00:00",
            },
            {
                "anomaly_id": "A002", "product_id": "P200", "product_name": "欧姆龙体温计",
                "anomaly_type": "price_gap", "severity": "warning",
                "detection_method": "rule",
                "metrics": {"expected_value": 89, "actual_value": 69, "deviation_percent": -22, "threshold": -15},
...
def sample_anomalies_none():
    return {
        "detection_summary": {
            "total_products_checked": 50, "anomalies_found": 0,
...
def sample_root_cause():
    return {
        ...
        "root_causes": [
            {
                "cause_type": "competitor", "cause_detail": "竞品大幅降价抢量",
                "confidence": 0.8,
                "evidence": ["竞品A降价20%", "竞品B上架同款"],
                "data_support": {"metric": "competitor_price", "before": 199, "after": 159, "change_percent": -20},
            },
        ],
...
def sample_action():
    return {
        ...
        "recommended_actions": [
            {
                "action_type": "price_adjust", "priority": "P0",
                "action_detail": "将价格下调至179元，匹配竞品价格带",
                "parameters": {"target_price": 179, "discount_percent": 10},
                "expected_outcome": "预计恢复80%销量",
                "estimated_impact": {"sales_change_percent": 80, "margin_change_percent": -5, "investment_required": 0},
