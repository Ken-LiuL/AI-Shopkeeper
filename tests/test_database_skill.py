...
class TestListProducts:
    ...
    async def test_list_products_default(self, db_skill_with_pool):
        ...
        conn.fetch.return_value = [
            {"product_id": "P001", "name": "血压计", "category": "医疗器械",
             "price": 199.0, "cost": 80.0, "stock": 50, "status": "active",
             "description": "", "created_at": None, "updated_at": None},
            {"product_id": "P002", "name": "体温计", "category": "医疗器械",
             "price": 29.0, "cost": 10.0, "stock": 100, "status": "active",
             "description": "", "created_at": None, "updated_at": None},
        ]
...
class TestUpdateProduct:
    ...
    async def test_update_product_empty_data(self, db_skill_with_pool):
        ...
        conn.fetchrow.return_value = {
            "product_id": "P001", "name": "血压计", "category": "血压计",
            "price": 199.0, "cost": 80.0, "stock": 50, "status": "active",
            "description": "", "created_at": None, "updated_at": None,
        }
...
class TestGetOrders:
    ...
    async def test_get_orders_default(self, db_skill_with_pool):
        ...
        conn.fetch.return_value = [
            {"order_id": "O001", "product_id": "P001", "product_name": "血压计",
             "quantity": 2, "unit_price": 199.0, "total_amount": 398.0,
             "order_date": datetime.now(), "status": "completed"},
        ]
...
class TestGetSalesStats:
    ...
    async def test_get_sales_stats(self, db_skill_with_pool):
        ...
        conn.fetch.return_value = [
            {"product_id": "P001", "product_name": "血压计",
             "total_quantity": 100, "total_revenue": 19900.0,
             "total_cost": 8000.0, "gross_profit": 11900.0,
             "gross_margin": 0.598, "order_count": 80},
        ]
...
class TestAlertCRUD:
    ...
    async def test_get_alerts(self, db_skill_with_pool):
        ...
        conn.fetch.return_value = [
            {"alert_id": 1, "product_id": "P001", "alert_type": "sales_drop",
             "severity": "critical", "title": "销量下降", "description": "desc",
             "root_cause": "", "suggestion": "", "status": "open",
...
class TestSelectionRun:
    ...
    async def test_get_latest_selection_runs(self, db_skill_with_pool):
        ...
        conn.fetch.return_value = [
            {"run_id": 2, "trigger": "manual", "status": "completed",
             "total_evaluated": 10, "recommended_count": 5, "top_score": 87.5,
             "results": None, "started_at": datetime.now(), "completed_at": datetime.now()},
            {"run_id": 1, "trigger": "scheduled", "status": "completed",
             "total_evaluated": 8, "recommended_count": 4, "top_score": 82.0,
             "results": None, "started_at": datetime.now(), "completed_at": datetime.now()},
        ]
