...
PRODUCTS: list[dict[str, Any]] = [
    # ── 血压计 (8) ──
    {"id": "BP001", "name": "欧姆龙 U726 上臂式电子血压计", "category": "血压计", "brand": "欧姆龙", "price": 329, "spec": "上臂式，智能加压，60组记忆", "reg_class": "二类"},
    {"id": "BP002", "name": "鱼跃 YE680A 臂式电子血压计", "category": "血压计", "brand": "鱼跃", "price": 219, "spec": "上臂式，双人记忆，语音播报", "reg_class": "二类"},
    {"id": "BP003", "name": "迈克大夫 BP A100 Plus 血压计", "category": "血压计", "brand": "迈克大夫", "price": 289, "spec": "上臂式，MAM技术三次测量取均值", "reg_class": "二类"},
    {"id": "BP004", "name": "欧姆龙 T30J 腕式电子血压计", "category": "血压计", "brand": "欧姆龙", "price": 259, "spec": "腕式，便携，姿势引导", "reg_class": "二类"},
    {"id": "BP005", "name": "九安 KD-5008 电子血压计", "category": "血压计", "brand": "九安", "price": 159, "spec": "上臂式，大屏显示，一键测量", "reg_class": "二类"},
    {"id": "BP006", "name": "鱼跃 YE666AR 蓝牙血压计", "category": "血压计", "brand": "鱼跃", "price": 299, "spec": "上臂式，蓝牙连接APP，云端记录", "reg_class": "二类"},
    {"id": "BP007", "name": "欧姆龙 J735 上臂式血压计", "category": "血压计", "brand": "欧姆龙", "price": 459, "spec": "上臂式，房颤检测，100组×2记忆", "reg_class": "二类"},
    {"id": "BP008", "name": "松下 EW-BU75 血压计", "category": "血压计", "brand": "松下", "price": 399, "spec": "上臂式，双传感器，不规则脉波检测", "reg_class": "二类"},

    # ── 血糖仪 (6) ──
    {"id": "BG001", "name": "三诺 安稳+ 血糖仪套装", "category": "血糖仪", "brand": "三诺", "price": 99, "spec": "含50条试纸+50采血针，0.6μL微量采血", "reg_class": "二类"},
    {"id": "BG002", "name": "鱼跃 580 血糖仪套装", "category": "血糖仪", "brand": "鱼跃", "price": 129, "spec": "含50条试纸，5秒出值，大屏语音", "reg_class": "二类"},
    {"id": "BG003", "name": "罗氏 逸动II 血糖仪", "category": "血糖仪", "brand": "罗氏", "price": 368, "spec": "含25条试纸，金电极技术，500组记忆", "reg_class": "三类"},
    {"id": "BG004", "name": "雅培 辅理善瞬感扫描式血糖仪", "category": "血糖仪", "brand": "雅培", "price": 599, "spec": "免采血，扫描即测，14天传感器", "reg_class": "三类"},
    {"id": "BG005", "name": "三诺 GA-3 血糖试纸 50支装", "category": "血糖耗材", "brand": "三诺", "price": 68, "spec": "配套三诺安稳+系列血糖仪", "reg_class": "二类"},
    {"id": "BG006", "name": "罗氏 逸动II 血糖试纸 50支装", "category": "血糖耗材", "brand": "罗氏", "price": 168, "spec": "配套罗氏逸动系列血糖仪", "reg_class": "三类"},

    # ── 体温计 (5) ──
    {"id": "TH001", "name": "欧姆龙 MC-246 电子体温计", "category": "体温计", "brand": "欧姆龙", "price": 39, "spec": "腋下测量，60秒速测，蜂鸣提示", "reg_class": "二类"},
    {"id": "TH002", "name": "鱼跃 YT-1 红外额温枪", "category": "体温计", "brand": "鱼跃", "price": 129, "spec": "1秒测温，非接触式，32组记忆", "reg_class": "二类"},
    {"id": "TH003", "name": "博朗 IRT6520 耳温枪", "category": "体温计", "brand": "博朗", "price": 349, "spec": "预热测量头，年龄选择功能，夜光显示", "reg_class": "二类"},
    {"id": "TH004", "name": "倍尔康 JXB-178 非接触式体温计", "category": "体温计", "brand": "倍尔康", "price": 89, "spec": "1秒测温，物体/体温双模式", "reg_class": "二类"},
    {"id": "TH005", "name": "可孚 电子体温计 软头款", "category": "体温计", "brand": "可孚", "price": 25, "spec": "软头设计，防水，适合婴幼儿", "reg_class": "二类"},

    # ── 制氧机 (4) ──
    {"id": "OX001", "name": "鱼跃 8F-5AW 5L家用制氧机", "category": "制氧机", "brand": "鱼跃", "price": 2899, "spec": "5L/min，93%±3%浓度，雾化功能", "reg_class": "二类"},
    {"id": "OX002", "name": "欧姆龙 HAO-2210 3L制氧机", "category": "制氧机", "brand": "欧姆龙", "price": 2199, "spec": "3L/min，静音设计≤45dB", "reg_class": "二类"},
    {"id": "OX003", "name": "鱼跃 9F-3BW 3L制氧机", "category": "制氧机", "brand": "鱼跃", "price": 1899, "spec": "3L/min，定时功能，带遥控", "reg_class": "二类"},
    {"id": "OX004", "name": "海龟 V1 便携式制氧机", "category": "制氧机", "brand": "海龟", "price": 3599, "spec": "便携式，脉冲供氧，1.8kg", "reg_class": "二类"},

    # ── 雾化器 (4) ──
    {"id": "NB001", "name": "欧姆龙 NE-C28 压缩式雾化器", "category": "雾化器", "brand": "欧姆龙", "price": 459, "spec": "压缩式，0.3ml/min雾化量，MMAD≤5μm", "reg_class": "二类"},
    {"id": "NB002", "name": "鱼跃 403AI 压缩式雾化器", "category": "雾化器", "brand": "鱼跃", "price": 289, "spec": "压缩式，儿童/成人面罩，低噪音", "reg_class": "二类"},
    {"id": "NB003", "name": "欧姆龙 NE-U200 网式雾化器", "category": "雾化器", "brand": "欧姆龙", "price": 899, "spec": "网式便携，97g超轻，静音", "reg_class": "二类"},
    {"id": "NB004", "name": "飞利浦 家用压缩式雾化器", "category": "雾化器", "brand": "飞利浦", "price": 399, "spec": "SideStream雾化技术，含儿童面罩", "reg_class": "二类"},

    # ── 轮椅/助行器 (4) ──
    {"id": "WC001", "name": "鱼跃 H062 铝合金折叠轮椅", "category": "轮椅", "brand": "鱼跃", "price": 999, "spec": "铝合金，折叠12kg，承重100kg", "reg_class": "一类"},
    {"id": "WC002", "name": "互邦 HBG25 轻便折叠轮椅", "category": "轮椅", "brand": "互邦", "price": 799, "spec": "碳钢车架，折叠收纳，实心轮胎", "reg_class": "一类"},
    {"id": "WC003", "name": "鱼跃 YU750 铝合金助行器", "category": "助行器", "brand": "鱼跃", "price": 189, "spec": "四脚八档调节，折叠便携", "reg_class": "一类"},
    {"id": "WC004", "name": "可孚 老人四脚拐杖", "category": "拐杖", "brand": "可孚", "price": 79, "spec": "铝合金，10档调高，防滑脚垫", "reg_class": "一类"},

    # ── 口罩/防护 (5) ──
    {"id": "MK001", "name": "振德 N95医用防护口罩 30只装", "category": "口罩", "brand": "振德", "price": 49.9, "spec": "N95级，BFE≥95%，独立包装", "reg_class": "二类"},
    {"id": "MK002", "name": "稳健 一次性医用外科口罩 50只", "category": "口罩", "brand": "稳健", "price": 24.9, "spec": "三层防护，BFE≥95%", "reg_class": "二类"},
    {"id": "MK003", "name": "3M 9501V+ KN95防护口罩 25只", "category": "口罩", "brand": "3M", "price": 79.9, "spec": "KN95级，带呼吸阀，耳戴式", "reg_class": "二类"},
    {"id": "MK004", "name": "海氏海诺 儿童医用外科口罩 50只", "category": "口罩", "brand": "海氏海诺", "price": 29.9, "spec": "儿童尺寸，卡通印花，三层防护", "reg_class": "二类"},
    {"id": "MK005", "name": "英科 一次性乳胶手套 100只 M码", "category": "防护手套", "brand": "英科", "price": 35.9, "spec": "医用级乳胶，无粉，M码", "reg_class": "一类"},

    # ── 创可贴/外伤 (4) ──
    {"id": "FA001", "name": "云南白药 创可贴 100片装", "category": "创可贴", "brand": "云南白药", "price": 29.9, "spec": "含云南白药药物成分，透气无纺布", "reg_class": "一类"},
    {"id": "FA002", "name": "邦迪 防水弹性创可贴 30片", "category": "创可贴", "brand": "邦迪", "price": 19.9, "spec": "防水透气，弹性好，适合关节部位", "reg_class": "一类"},
    {"id": "FA003", "name": "海氏海诺 碘伏消毒棉棒 50支", "category": "消毒用品", "brand": "海氏海诺", "price": 16.9, "spec": "含0.5%有效碘，一次性独立包装", "reg_class": "一类"},
    {"id": "FA004", "name": "利尔康 75%酒精消毒液 500ml", "category": "消毒用品", "brand": "利尔康", "price": 18.9, "spec": "75%医用酒精，皮肤/物表消毒", "reg_class": "一类"},

    # ── 血氧仪 (3) ──
    {"id": "PO001", "name": "鱼跃 YX306 指夹式血氧仪", "category": "血氧仪", "brand": "鱼跃", "price": 159, "spec": "OLED双色显示，6秒速测，PI灌注指数", "reg_class": "二类"},
    {"id": "PO002", "name": "康泰 CMS50D 指夹血氧仪", "category": "血氧仪", "brand": "康泰", "price": 89, "spec": "OLED屏，四方向显示，10小时续航", "reg_class": "二类"},
    {"id": "PO003", "name": "鱼跃 YX102 血氧仪", "category": "血氧仪", "brand": "鱼跃", "price": 119, "spec": "大屏显示，血氧+脉率+PI", "reg_class": "二类"},

    # ── 护具/理疗 (4) ──
    {"id": "HT001", "name": "仙鹤 CQ-29 神灯理疗仪", "category": "理疗仪", "brand": "仙鹤", "price": 229, "spec": "TDP特定电磁波，定时功能", "reg_class": "二类"},
    {"id": "HT002", "name": "LP 733CN 护膝", "category": "护具", "brand": "LP", "price": 89, "spec": "双弹簧支撑，透气面料，可调节", "reg_class": "一类"},
    {"id": "HT003", "name": "欧姆龙 HV-F021 低频理疗仪", "category": "理疗仪", "brand": "欧姆龙", "price": 299, "spec": "低频电刺激，9种模式，3档强度", "reg_class": "二类"},
    {"id": "HT004", "name": "南极人 自发热护腰带", "category": "护具", "brand": "南极人", "price": 69, "spec": "托玛琳自发热，加宽设计", "reg_class": "一类"},

    # ── 其他 (3) ──
    {"id": "OT001", "name": "鱼跃 听诊器 全铜听头", "category": "听诊器", "brand": "鱼跃", "price": 49, "spec": "双面听头，铜制件，适合家用", "reg_class": "二类"},
    {"id": "OT002", "name": "一周药盒 便携分装28格", "category": "药盒", "brand": "通用", "price": 15.9, "spec": "7天×4格，食品级PP材质", "reg_class": "非医疗器械"},
    {"id": "OT003", "name": "雾化面罩 成人/儿童款", "category": "雾化配件", "brand": "通用", "price": 12.9, "spec": "配套主流雾化器，含导气管", "reg_class": "一类"},

    # ── 补充耗材/配件 ──
    {"id": "AC001", "name": "三诺 采血笔 + 100支采血针", "category": "血糖耗材", "brand": "三诺", "price": 39, "spec": "5档深度可调，配100支一次性采血针", "reg_class": "二类"},
    {"id": "AC002", "name": "仲景 医用棉签 500支", "category": "棉签", "brand": "仲景", "price": 12.9, "spec": "脱脂棉头，独立纸轴", "reg_class": "一类"},
    {"id": "AC003", "name": "海氏海诺 酒精棉片 100片", "category": "消毒用品", "brand": "海氏海诺", "price": 15.9, "spec": "75%酒精，独立包装，采血前消毒", "reg_class": "一类"},
    {"id": "AC004", "name": "3M 弹性绷带 7.5cm×4.5m", "category": "绷带", "brand": "3M", "price": 24.9, "spec": "弹性好，自粘设计，透气", "reg_class": "一类"},
    {"id": "AC005", "name": "退热贴 儿童/成人 6贴装", "category": "退热贴", "brand": "兵兵", "price": 19.9, "spec": "水凝胶物理降温，6-8小时持续", "reg_class": "一类"},
    {"id": "AC006", "name": "轮椅坐垫 防褥疮记忆棉", "category": "轮椅配件", "brand": "通用", "price": 99, "spec": "记忆棉，透气面料，防滑底", "reg_class": "非医疗器械"},
    {"id": "AC007", "name": "血压记录本", "category": "健康管理", "brand": "通用", "price": 9.9, "spec": "90天记录，含血压知识手册", "reg_class": "非医疗器械"},
]
...
CONTRAINDICATED_FOR: list[tuple[str, str, str]] = [
    ...
    # 制氧机对儿童的限制
    ("OX001", "儿童", "5L大流量制氧机不适合儿童自行使用，高浓度氧气可能导致氧中毒，须在医生指导下使用"),
...
USED_IN: list[tuple[str, str]] = [
    # 血压计 → 家庭日常监测、慢病管理
    ("BP001", "家庭日常监测"), ("BP001", "慢病管理"),
    ("BP002", "家庭日常监测"), ("BP002", "慢病管理"),
    ("BP003", "家庭日常监测"), ("BP003", "慢病管理"),
    ("BP004", "出行便携"), ("BP004", "家庭日常监测"),
    ("BP005", "家庭日常监测"),
    ("BP006", "慢病管理"), ("BP006", "家庭日常监测"),
    ("BP007", "慢病管理"), ("BP007", "家庭日常监测"),
    ("BP008", "家庭日常监测"), ("BP008", "慢病管理"),

    # 血糖仪 → 家庭日常监测、慢病管理
    ("BG001", "家庭日常监测"), ("BG001", "慢病管理"),
    ("BG002", "家庭日常监测"), ("BG002", "慢病管理"),
    ("BG003", "慢病管理"),
    ("BG004", "慢病管理"), ("BG004", "家庭日常监测"),
    ("BG005", "慢病管理"),
    ("BG006", "慢病管理"),

    # 体温计 → 感冒发烧、家庭日常监测
    ("TH001", "感冒发烧"), ("TH001", "家庭日常监测"),
    ("TH002", "感冒发烧"), ("TH002", "家庭日常监测"),
    ("TH003", "感冒发烧"), ("TH003", "家庭日常监测"),
    ("TH004", "感冒发烧"), ("TH004", "办公防护"),
    ("TH005", "感冒发烧"), ("TH005", "家庭日常监测"),

    # 制氧机 → 慢病管理、术后护理
    ("OX001", "慢病管理"), ("OX001", "术后护理"),
    ("OX002", "慢病管理"), ("OX002", "术后护理"),
    ("OX003", "慢病管理"),
    ("OX004", "出行便携"),

    # 雾化器 → 感冒发烧、慢病管理
    ("NB001", "感冒发烧"), ("NB001", "慢病管理"),
    ("NB002", "感冒发烧"), ("NB002", "慢病管理"),
    ("NB003", "出行便携"), ("NB003", "感冒发烧"),
    ("NB004", "感冒发烧"),

    # 轮椅/助行 → 术后护理、出行便携
    ("WC001", "术后护理"), ("WC001", "出行便携"),
    ("WC002", "术后护理"),
    ("WC003", "术后护理"), ("WC003", "家庭日常监测"),
    ("WC004", "出行便携"),

    # 口罩/防护 → 感冒发烧、办公防护
    ("MK001", "感冒发烧"), ("MK001", "办公防护"),
    ("MK002", "感冒发烧"), ("MK002", "办公防护"),
    ("MK003", "办公防护"), ("MK003", "出行便携"),
    ("MK004", "感冒发烧"),
    ("MK005", "外伤处理"), ("MK005", "术后护理"),

    # 创可贴/外伤 → 外伤处理
    ("FA001", "外伤处理"),
    ("FA002", "外伤处理"), ("FA002", "出行便携"),
    ("FA003", "外伤处理"),
    ("FA004", "外伤处理"), ("FA004", "办公防护"),

    # 血氧仪 → 家庭日常监测、慢病管理
    ("PO001", "家庭日常监测"), ("PO001", "慢病管理"),
    ("PO002", "家庭日常监测"),
    ("PO003", "家庭日常监测"),

    # 护具/理疗 → 术后护理
    ("HT001", "术后护理"),
    ("HT002", "术后护理"), ("HT002", "出行便携"),
    ("HT003", "术后护理"),
    ("HT004", "家庭日常监测"),
...
HELPS_WITH: list[tuple[str, str]] = [
    # 血压计 → 头晕（血压异常可致头晕）
    ("BP001", "头晕"), ("BP002", "头晕"), ("BP003", "头晕"),
    ("BP005", "头晕"), ("BP006", "头晕"), ("BP007", "头晕"), ("BP008", "头晕"),

    # 血糖仪 → 血糖异常
    ("BG001", "血糖异常"), ("BG002", "血糖异常"), ("BG003", "血糖异常"),
    ("BG004", "血糖异常"),
    ...
    # 创可贴/外伤 → 伤口出血
    ("FA001", "伤口出血"), ("FA002", "伤口出血"),
    ("FA003", "伤口出血"), ("AC004", "伤口出血"),

    # 护具/理疗 → 关节疼痛
    ("HT001", "关节疼痛"), ("HT002", "关节疼痛"),
    ("HT003", "关节疼痛"), ("HT004", "关节疼痛"),
...
ALTERNATIVE_TO: list[tuple[str, str]] = [
    # 血压计互为替代
    ("BP001", "BP002"), ("BP001", "BP003"), ("BP001", "BP005"),
    ("BP002", "BP005"), ("BP002", "BP006"),
    ("BP003", "BP008"), ("BP006", "BP007"),

    # 血糖仪互为替代
    ("BG001", "BG002"), ("BG001", "BG003"),
    ("BG002", "BG003"), ("BG003", "BG004"),
    ...
    # 制氧机互为替代
    ("OX001", "OX002"), ("OX001", "OX003"),
    ("OX002", "OX003"),

    # 雾化器互为替代
    ("NB001", "NB002"), ("NB001", "NB004"),
    ("NB002", "NB004"), ("NB003", "NB001"),
    ...
    # 血氧仪互为替代
    ("PO001", "PO002"), ("PO001", "PO003"), ("PO002", "PO003"),
...
def build_cypher_statements() -> list[tuple[str, dict[str, Any]]]:
    ...
    # 创建约束/索引
    for label, prop in [
        ("Product", "product_id"), ("Population", "name"),
        ("Scenario", "name"), ("Symptom", "name"),
    ]:
        stmts.append((
    ...
    for p in PRODUCTS:
        stmts.append((
            ...
            {"pid": p["id"], "name": p["name"], "category": p["category"],
             "brand": p["brand"], "price": p["price"], "spec": p["spec"],
...
def print_stats() -> None:
    ...
    total_rels = (len(SUITABLE_FOR) + len(CONTRAINDICATED_FOR) + len(USED_IN)
                  + len(HELPS_WITH) + len(OFTEN_BOUGHT_WITH) + len(ALTERNATIVE_TO))
    print(f"  ────────────────────────────")
    print(f"  总关系数:                  {total_rels}")
    print(f"  总节点数:                  {len(PRODUCTS) + len(POPULATIONS) + len(SCENARIOS) + len(SYMPTOMS)}")
    print("=" * 60)
